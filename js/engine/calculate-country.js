import { selectBestRoute } from './select-best-route.js?v=6.0.0';
import { COUNTRY_GROUP_LABELS_RU } from './status-contract.js?v=6.0.0';
import { convertMoney } from './currency.js?v=6.0.0';
