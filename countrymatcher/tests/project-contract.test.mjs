...
test('Pages artifact is a positive runtime allowlist', async () => {
  ...
  try {
    ...
    for (const required of [
      ...
      'data/ES-research-v4.0.json', 'data/AR-research-v4.0.json', 'data/UY-research-v4.0.json', 'data/BR-research-v4.0.json',
...
test('active matcher declares a non-empty list of Final Lock RP4 packages', async () => {
  ...
  assert.deepEqual(filenames, ['ES-research-v4.0.json', 'AR-research-v4.0.json', 'UY-research-v4.0.json', 'BR-research-v4.0.json']);
