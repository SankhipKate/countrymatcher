...
Пакет `data/brazil-research-v3.0.json` и материалы `docs/research/brazil/` подключены к публичному расчёту версии 7.0.1. Исследование содержит восемь публикуемых маршрутов и пять городов.
