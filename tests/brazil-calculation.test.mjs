...
test('public matcher loads Brazil data, adapter, flag, cities and version 7.0.0', async () => {
  ...
  assert.match(app, /brazil-research-v3\.0\.json\?v=7\.0\.0/);
  ...
  assert.match(html, /версия 7\.0\.0/);
