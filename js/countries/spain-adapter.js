...
import { ROUTE_STATUSES, STATUS_LABELS_RU, resolveStatusConflict } from '../engine/status-contract.js?v=7.0.0';
import { INCOME_TYPE_BY_SCENARIO, ROUTE_RULES } from './spain-rules.js?v=7.0.0';
